...
def test_basic_functionality():
    ...
    captioner_cpu = GitBaseCaptioner(
        dtype=torch.float32,
        device="cpu",
        use_compile=False,
...
def test_gpu_optimizations():
    ...
    configs = [
        ...
        {
            'name': 'FP16 Optimization',
            'dtype': torch.float16,
            'use_compile': False,
            'use_channels_last': False
        },
        {
            'name': 'BF16 Optimization',
...
def test_different_generation_modes():
    ...
    modes = [
        {
            'name': 'Ultra Fast (max_length=10)',
            'params': {'max_length': 10, 'num_beams': 1, 'do_sample': False}
        },
        {
            'name': 'Fast (max_length=20)',
            'params': {'max_length': 20, 'num_beams': 1, 'do_sample': False}
        },
        {
            'name': 'Quality (max_length=30, beams=3)',
            'params': {'max_length': 30, 'num_beams': 3, 'do_sample': False}
        },
        {
