    ...
    def _warmup(self):
        ...
        try:
            ...
            if self.use_channels_last:
                inputs = {k: v.to(memory_format=torch.channels_last) if v.dim() == 4 else v 
...
def get_gitbase_captioner(dtype: torch.dtype = torch.float16,
                         use_compile: bool = True,
                         use_channels_last: bool = True) -> GitBaseCaptioner:
    """
...
def caption_image_bytes(image_bytes: bytes, 
