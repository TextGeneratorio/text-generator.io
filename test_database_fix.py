...
def test_database_connection():
    ...
    try:
        from questions.db_models_postgres import engine, DATABASE_URL, IS_PRODUCTION, ENVIRONMENT
...
def test_environment_separation():
    ...
    try:
        ...
        from questions.db_models_postgres import DATABASE_URL, IS_PRODUCTION, ENVIRONMENT
