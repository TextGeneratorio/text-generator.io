...
logconfig_dict = {
    ...
    "handlers": {
        ...
        "access_console": {"class": "logging.StreamHandler", "formatter": "access", "stream": "ext://sys.stdout"},
    },
    "loggers": {
        "gunicorn": {"level": os.environ.get("LOG_LEVEL", "INFO").upper(), "handlers": ["console"], "propagate": False},
        "gunicorn.access": {
        ...
        "uvicorn": {"level": os.environ.get("LOG_LEVEL", "INFO").upper(), "handlers": ["console"], "propagate": False},
        "uvicorn.access": {
            "level": os.environ.get("LOG_LEVEL", "INFO").upper(),
            "handlers": ["access_console"],
            "propagate": False,
    ...
    "root": {"level": os.environ.get("LOG_LEVEL", "INFO").upper(), "handlers": ["console"]},
}
